#
#  Be sure to run `pod spec lint SwiftTryCatch.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    Adds try-catch support for Swift, yay
                   DESC
  ...
  # Or just: s.author    = "Linus Oleander"
  # s.authors            = { "Linus Oleander" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Linus Oleander"
